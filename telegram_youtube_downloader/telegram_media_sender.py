...
class TelegramMediaSender:
    ...
    def send_text(self, chat_id, text):
        try: 
            ...
            timeout = self.__telegram_options["text_timeout_segundos"]
    ...
    def send_audio(self, chat_id, file_path, remove=False):
        try:
            ...
            with open(file_path, 'rb') as audio:
                ...
                timeout = self.__telegram_options["audio_timeout_segundos"]
    ...
    def send_video(self, chat_id, file_path, remove=False):
        try:
            ...
            with open(file_path, 'rb') as video:
                ...
                timeout = self.__telegram_options["video_timeout_segundos"]
